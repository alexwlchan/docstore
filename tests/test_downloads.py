...
def test_guess_filename_with_no_content_disposition():
    msg = Message()
    assert guess_filename("https://i.org/example.png", headers=msg) == "example.png"


def test_guess_filename_with_content_disposition():
    msg = Message()
...
def test_guess_filename_with_content_disposition_but_no_filename():
    msg = Message()
